      ...
      <main className="relative z-10 px-6 lg:px-12 py-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          ...
          {userTier !== "ultra" && (
            <Link
              href="/pricing"
              className="p-6 rounded-xl bg-gradient-to-br from-emerald-600/20 to-teal-600/20 border border-emerald-500/30 hover:border-emerald-500/50 transition-colors group"
            >
