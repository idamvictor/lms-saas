            ...
            {[
              {
                ...
                content:
                  "The teaching style at Vice Academy is incredible. I went from knowing nothing to landing my first dev job in 6 months!",
                avatar: "🧑‍💻",
              },
              {
                name: "Sarah Miller",
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-zinc-600">
              © 2024 Vice Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
